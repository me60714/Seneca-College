...
int main() {
   ...
   // Complete the function's arguments list1
   ...
   // Complete the function's arguments search1
   ...
   // Complete the function's arguments list2
   ...
   // Complete the function's arguments search2
   ...
   // Complete the function's arguments list3
   ...
   // Complete the function's arguments search3
   ...
   // Complete the function's arguments search4
   ...
   // Complete the function's arguments list4
