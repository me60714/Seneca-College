...
void populateTickets(struct Ticket tickets[], int arrSize)
{
    ...
    struct Ticket tmp[5] = {
        ...
        {60001, 30004, 1, "Frequent Disconnects", 2,
         // Ticket messages:
         {{'C', "Betty Boop", "Every time I go near the microwave the unit disconnects."}, {'A', "Will Smith", "Don't go near the microwave."}}},
        ...
        {80599, 30004, 0, "Nothing happens...", 7,
         // Ticket messages:
         {{'C', "Betty Boop", "Instructions state to 'say yes' to the prompts - but nothing happens."}, {'A', "Fred Flintstone", "Is this when setting up the unit for the first time?"}, {'C', "Betty Boop", "Yes - it keeps asking if I'm ready to start and I tell it 'yes' nothing happens."}, {'A', "Fred Flintstone", "Are you pressing the 'yes' button on the unit?"}, {'C', "Betty Boop", "No, instructions state to say yes - not press any buttons."}, {'A', "Will Smith", "'say' was meant to be interpretted as press the 'yes' button."}, {'C', "Betty Boop", "Oh I get it now - thanks!"}}},
        // Ticket Test Record 5
        {80020, 20020, 1, "It's broken/does not work", 3,
         // Ticket messages:
         {{'C', "Shrimpy Shrimp", "When I took it out of the box, it's in pieces."}, {'A', "Fred Flintstone", "You have to assemble it - read the instructions."}, {'C', "Shrimpy Shrimp", "What are instructions?"}}}};
